...
# version: u212-alpine-d19.03.1-m3.6.1-s1.2.8 (2019-09-01)
# Content:
#   - OpenJDK 1.8 (8u212-jdk-alpine)
#   - Maven v3.x.y
#   - Sbt v1.x.y
...
# Example:
#   $ docker build --squash --force-rm -t btnguyen2k/cicd-java8:u212-alpine-d19.03.1-m3.6.1-s1.2.8 -f alpine-d19-m3-s1.Dockerfile .

FROM openjdk:8u212-jdk-alpine

MAINTAINER Thanh Nguyen <btnguyen2k@gmail.com>, version: u212-alpine-d19.03.1-m3.6.1-s1.2.8
